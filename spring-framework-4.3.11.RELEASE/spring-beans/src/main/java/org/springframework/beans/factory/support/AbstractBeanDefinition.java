...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * 是否抽象，来自 bean 属性 abstract
	 */
	private boolean abstractFlag = false;

	/**
	 * 是否是延迟加载，来自属性 lazy-init
	 */
	...
	/**
	 * 用来表示一个 bean 的实例依靠另一个 bean 先实例化，对应 bean 属性 depend-on
	 */
	...
	/**
	 * 自动装配时当出现多个 bean 候选者，将作为首选者，对应 bean 属性 primary
	 */
	 ...
	 * <bean id="instanceFactoryBean" class="com.tb.test.InstanceFactoryBean" />
	...
	/**
	 * 初始化方法，对应 bean 的 init-method 属性
	 */
	private String initMethodName;

	/**
	 * 销毁方法，对应 bean 的 destroy-method 属性
	 */
