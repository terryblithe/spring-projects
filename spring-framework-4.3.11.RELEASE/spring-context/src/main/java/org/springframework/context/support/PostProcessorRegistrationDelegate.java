...
class PostProcessorRegistrationDelegate {
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		if (beanFactory instanceof BeanDefinitionRegistry) {
			...
			// 获取优先级 BeanDefinitionRegistryPostProcessor
			...
			// 按 order 排序并注册 priorityOrderedPostProcessors
			...
			// 获取有 order 的 BeanDefinitionRegistryPostProcessor
			...
			// 按 order 排序并注册 orderedPostProcessors
			sortPostProcessors(beanFactory, orderedPostProcessors);
			registryPostProcessors.addAll(orderedPostProcessors);
			invokeBeanDefinitionRegistryPostProcessors(orderedPostProcessors, registry);

			// Finally, invoke all other BeanDefinitionRegistryPostProcessors until no further ones appear.
			// 将剩下的 BeanDefinitionRegistryPostProcessor 获取并注册
			...
			// 激活 BeanFactoryPostProcess 方法，之前激活的是 PostProcessorBeanDefinitionRegistry
	...
	/**
	 * 该方法的功能是将配置文件中的 BeanPostProcessor 提取出来并注册进入 BeanFactory。
	 * Spring 中支持对 BeanPostProcessor 的排序，根据 PriorityOrdered、Ordered 或者无序进行排序
	 */
	public static void registerBeanPostProcessors(
		...
		/*
		BeanPostProcessorChecker 是一个普通的信息打印，可能会有些情况，当 Spring 的配置中的后处理器还没有被注册就已经开始了 bean 的
		初始化时，便会打印出 BeanPostProcessorChecker 中设定的信息。
		 */
